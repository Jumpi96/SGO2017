...
namespace SGO.Migrations
{
    ...
    [Migration("20170909183955_DalePelotudo")]
    partial class DalePelotudo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGO.Models.DetalleSubItem", b =>
                {
                    ...
                    b.Property<int?>("SubItemDeItemID");

                    b.HasKey("ID");

                    b.HasIndex("ObraID");

                    b.HasIndex("SubItemDeItemID");
            ...
            modelBuilder.Entity("SGO.Models.SubItemDeItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SGO.Models.DetalleSubItem", b =>
                {
                    ...
                    b.HasOne("SGO.Models.SubItemDeItem", "SubItemDeItem")
                        .WithMany()
                        .HasForeignKey("SubItemDeItemID");
                });
