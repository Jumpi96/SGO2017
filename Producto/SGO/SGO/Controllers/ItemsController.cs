...
namespace SGO.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(SGOContext context)
        {
            _context = context;
        }
        ...
        public Item ItemByNombreYSubrubro(string nombre, SubRubro subRubro)
        {
            return _context.Item.SingleOrDefault(m => m.Nombre.Equals(nombre) && m.SubRubro.ID == subRubro.ID);
        }

        public Item Insertar(Item item)
        {
            if (ModelState.IsValid)
            {
                _context.Add(item);
